						...
						else
						{
							...
							else
							{
								if (sym == forsym)
								{
									...
									{
										getsymdo;
										statementdo(nxtlev, ptx, lev); //语句A代码
										if (sym != semicolon)
											error(10); //分号出错
										else
										{
											cx1 = cx;
											getsymdo;
											conditiondo(nxtlev, ptx, lev); //语句B代码
											if (sym != semicolon)
												error(10); //语句缺少分号出错
											else
											{
												...
												getsymdo;
												cx4 = cx;
												statementdo(nxtlev, ptx, lev); //语句C代码
												if (sym != rparen)
													error(22); //右括号出错
												else
												{
													...
													getsymdo;
													cx5 = cx;
													statementdo(nxtlev, ptx, lev); //右括号之后代码
													code[cx3].a = cx5;
													gendo(jmp, 0, cx4);
													code[cx2].a = cx;
												}
